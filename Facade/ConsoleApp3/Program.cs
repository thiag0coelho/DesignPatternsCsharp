    ...
    class Program
    {
        ...
        public class MagicSquareGenerator
        {
            public List<List<int>> Generate(int size)
            {
                ...
                bool verified = false;
                List<List<int>> splittedArray = new List<List<int>>();
                ...
                while (!verified)
                {
                    ...
                    {
                        generatedArray.Add(generator.Generate(size));
                    }

                    splittedArray = splitter.Split(generatedArray);

                    verified = verifier.Verify(splittedArray);
                }
